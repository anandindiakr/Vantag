        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-6 space-y-4">
          ...
          {discovered.length === 0 && !scanning && (
            <p className="text-xs text-slate-500">
              Nothing found yet? Cameras behind an NVR often don't answer scans directly —
              use <Link to="/cameras/manage" className="text-violet-400 underline">manual add</Link>{' '}
              with the NVR's IP and channel paths instead.
            </p>
          )}
