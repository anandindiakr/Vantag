...
# Silence the noisy libav/FFmpeg "method DESCRIBE failed: 401 Unauthorized"
# spam that floods the console while discovery brute-forces RTSP credentials.
# Must be set BEFORE OpenCV (cv2) is first imported below. -8 == AV_LOG_QUIET.
