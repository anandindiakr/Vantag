...
from .edge_router import generate_registration_token  # top-level import — catches circular issues at startup
...
async def step5_install_agent(
    ...
    try:
        ...
        region_url_map = {
            "india": "https://retailnazar.com",
            "singapore": "https://retail-vantag.com",
            "malaysia": "https://jagajaga.my",
        }
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to provision edge agent / generate QR: {exc}",
        ) from exc
