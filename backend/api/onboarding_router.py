...
async def step1_shop_details(
    ...
    await session.execute(
        ...
        .values(
            ...
            region={"IN": "india", "SG": "singapore", "MY": "malaysia", "PH": "philippines", "ID": "indonesia"}.get(body.country.upper(), "india"),
...
async def step5_install_agent(
    ...
    region_url_map = {"india": "https://retailnazar.com", "singapore": "https://retail-vantag.com", "malaysia": "https://jagajaga.my", "philippines": "https://retailbantay.com", "indonesia": "https://retailpantau.com"}
